...
import { Container, Button, Form, Header, Grid, Image, Message, Progress } from 'semantic-ui-react';
...
const Cls_LluviaMatrix = () => {
  ...
  useEffect(() => {
    ...
    const Gv_colores = ['#0F0', '#FF0', '#F00', '#0FF', '#F0F', '#00F', '#FFF','#9147ff'];
...
function ClsApp() {
  ...
  useEffect(() => {
    ...
    Gv_socket.on('nuevaPregunta', (Lv_datos: { Lv_pregunta: string, Lv_respuestas: string[], Ln_temporizador: number, Lv_imagen?: string, Lv_nivel: string, Lv_categoria: string, Ln_numeroPregunta: number }) => {
      ...
      Lv_setSegundos(Lv_datos.Ln_temporizador);
    ...
    <div className="quiz-layout">
        ...
        <Grid.Column width={12} className="quiz-main">
          <div className="quiz-container">
            <div className="quiz-header">
              <Header as="h1">Batalla Trivial</Header>
              <p>ID Sala: {Lv_sala}</p>
            </div>
            <div className="quiz-content">
              <Progress value={Ln_numeroPreguntaActual} total={10} progress="ratio" color="blue" />
              <div className="timer">
                <p>
              ...
              {Lv_resultadoRespuesta && (
                <Message
                  positive={Lv_resultadoRespuesta.Lb_esCorrecto}
                  negative={!Lv_resultadoRespuesta.Lb_esCorrecto}
                  content={Lv_resultadoRespuesta.Lv_mensaje}
                />
              )}
            </div>
          </div>
      ...
      {(Lv_ganadores !== null || Lb_esEmpate) && (
        ...
        <div className="scores-container">
          <Header as="h2"  style={{ color: '#9147ff' }}>Tabla de puntajes</Header>
          {Ln_jugadores.map((Lv_jugador, index) => (
            <p key={index}>
              <FontAwesomeIcon icon={faUser} /> {Lv_jugador.Lv_nombre}: {Lv_jugador.Ln_puntaje}
            </p>
